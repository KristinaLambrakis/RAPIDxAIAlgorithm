...
from aiml.pytorch.revasc.model_revasc import get_network
...
def main(args):
    ...
    target_info = {
        ...
        'regression_cols': [],
        'binary_cls_cols': ['cabg', 'intervention'],
        'cls_cols_dict': {},
        'loss_weights': {'cabg': 1., 'intervention': 1.}  # , 'onset': 1, 'outl1': 1., 'outl2': 1., 'out3c': 1.,
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='../data/revasc_exp_no2')
    ...
    parser.add_argument('--data_path', type=str, default=cache_root_dr)
