...
import aiml.pytorch.outcome_data_ecg.protocol as protocol
from service.v4.protocol import prefiller
...
class TroponinDataset(data.Dataset):
    ...
    def __init__(self, csv_path,
                 ...
                 use_random_crop=None, transform=None, prefill_feature=None):
        ...
        self.binary_keys = protocol.get_binary_keys()
    ...
    def get_item(self, info):
        ...
        # raw trop: 6, time trop: 6, phys: 21, bio: 5, bin: 22, luke: 10
...
def get_loader_from_dataset(csv_path, target_info, target_translator, batch_size, transform, set_key, set_scope,
                            use_random_crop, prefill_feature, shuffle, num_workers, drop_last):
