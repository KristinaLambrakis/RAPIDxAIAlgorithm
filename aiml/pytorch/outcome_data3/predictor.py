...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='../data/outcome_v3_exp_no2')
    ...
    parser.add_argument('--reload_path', type=str,
                        default=os.path.join(pytorch_data_server_root, 'outcome_v3_prefill',
                                                                       'outcome_v3_lm10_lr1e-3_b128_s0/net_e100.ckpt'),
